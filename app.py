...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Văn Tuân - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 081 2060 673</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Văn Tuân - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 081 2060 673</div>", unsafe_allow_html=True)
